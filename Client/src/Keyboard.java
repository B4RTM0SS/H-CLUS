...
public class Keyboard {
     ...
     *
     * @param count the error count to zero.
     */
     ...
     *
     * @return a boolean indicating whether errors are printed to standard output.
     */
     ...
     *
     * @param flag indicating whether errors are to be printed to standard output.
     */
    ...
    /**
     * Gets the next input token assuming it may be on subsequen input lines.
     *
     ...
     *
     * @param skip true if subsequent lines are used.
     *
     * @return the next input token.
     */
     ...
     *
     * @return true if there are no more tokens to read.
     */
     ...
     *
     * @return a substring read from standard input.
     */
